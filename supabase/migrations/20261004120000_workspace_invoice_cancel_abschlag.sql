-- RECHNUNGSBEREICH-03D -- die Abschlagsrechnung wird stornierbar.
--
-- Folgemigration zu 20261003120000 (dort steht die Fassung mit der
-- Teilrechnung; sie ist remote angewendet und wird hier nicht umgeschrieben).
--
-- Einzige fachliche Aenderung: `abschlag` in der Liste der stornierbaren
-- Belegarten. Alles andere bleibt -- Idempotenz, Zahlungssperre, Stornogrund,
-- internes Storno bzw. Korrekturbeleg und das Verhalten fuer rechnung,
-- teilrechnung und schluss. Keine Datenmigration, keine Nummernlogik.
