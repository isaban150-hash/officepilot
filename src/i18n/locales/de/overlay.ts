/** Sie-form and terminology overrides applied on top of legacy monolith keys. */
export const deOverlay = {
  'mobile.home.greeting': 'Was möchten Sie erledigen?',
  'mobile.home.assistantTitle': 'Was möchten Sie erledigen?',
  'mobile.add.pageSubtitle': 'Wählen Sie, wie Sie das Dokument erfassen möchten.',
