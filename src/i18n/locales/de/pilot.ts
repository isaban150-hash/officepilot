export const dePilot = {
  'persist.banner.message':
    'Speichern fehlgeschlagen. Änderungen könnten nach einem Neustart verloren gehen. Bitte prüfe den Browserspeicher und lade eine Datensicherung herunter.',
  'persist.banner.openBackup': 'Zur Datensicherung',
  'persist.failed.userAction':
    'Die Änderung ist in der App sichtbar, konnte aber nicht dauerhaft gespeichert werden. Bitte prüfe den Speicher und erstelle eine Datensicherung.',

  'pilot.hints.title': 'Hinweise zum Pilotbetrieb',
