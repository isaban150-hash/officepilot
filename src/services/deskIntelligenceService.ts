...
const PENDING_DESK_KEYS: Record<string, TranslationKey> = {
  ...
  'pending.highlight.dueTaskTodayOne': 'desk.priority.dueTaskTodayOne',
  'pending.highlight.overdueTasks': 'desk.priority.overdueTasks',
  'pending.highlight.overdueTaskOne': 'desk.priority.overdueTaskOne',
