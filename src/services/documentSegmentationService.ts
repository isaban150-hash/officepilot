...
const CONTRACT_CORE_MARKERS =
  /werkvertrag|bau[\s-]?subunternehmer|subunternehmervertrag|auftraggeber|auftragnehmer|vertragsgegenstand|vergütung|zahlungsbedingungen|nachweispflicht|unterschrift|vertragsdatum|gewährleistungsfrist|vertragsstrafe|allgemeine\s+vertragsbedingungen|besondere\s+vertragsbedingungen/i;
